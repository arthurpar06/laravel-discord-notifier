...
Guarantee that commit messages follow Conventional Commits — the input contract the versioning engine depends on — by linting every commit on pull requests under a merge-commit workflow.
